...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Accounts /</span><span> Add Accounts</span>
        </h4>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <h4 class="mb-1 mt-3">Add a new Account</h4>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="Tên người dùng" name="name" aria-label="Tên người dùng" required
                                        autofocus>
                                ...
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="file" class="form-control" id="avatar" placeholder="Avatar"
                                        name="avatar" aria-label="Avatar" required>
