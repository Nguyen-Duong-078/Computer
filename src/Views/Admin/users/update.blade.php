...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Accounts /</span><span> Update Accounts</span>
        </h4>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <h4 class="mb-1 mt-3">Update a Account</h4>
                    </div>
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h5 class="card-tile mb-0">Thông tin người dùng</h5>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    ...
                                    <label for="ecommerce-product-name">Tên người dùng</label>
                                </div>
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="Email" value="{{ $user['email'] }}" name="email" aria-label="Email"
                                        required>
                                    <label for="ecommerce-product-name">Email</label>
                                </div>
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                ...
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="file" class="form-control" id="avatar" placeholder="Avatar"
                                        name="avatar" aria-label="Avatar">
                                    <img class="mt-2" src="{{ $user['avatar'] }}" alt="" width="60px"
                                        style="border-radius: 5px">
                                    <label for="ecommerce-product-name">Avatar</label>
                                    {{-- <img class="mt-2" src="{{ $user['avatar'] }}" alt=""
