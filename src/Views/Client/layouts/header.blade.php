        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col d-none d-lg-block">
                    <div class="top-nav">
                        <ul>
                            <li><a href="tel:0123456789"><i class="fa fa-phone"></i> 0876.55.2004</a></li>
                            <li><a href="mailto:demo@example.com"><i class="fa fa-envelope-o"></i>
                                    nguyenduong0782004@gmail.com</a></li>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-3 col">
                    <div class="header-logo">
                        <a href="/"><img src="/assets/client/images/logo/logo.png" alt="Site Logo" /></a>
                    </div>
                </div>
            ...
            <div class="header-nav">
                <div class="main-menu position-relative">
                    <ul>
                        ...
                        <li class="dropdown "><a href="#">Computer
